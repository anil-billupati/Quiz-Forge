...
import { Play, Trophy, Loader2, AlertCircle, LogOut, LogIn } from "lucide-react";
...
export default function JoinContestPage() {
  ...
  const canJoinLive = (registration: RegistrationResponse | null, status: string) => {
    return (
      status === "LIVE" &&
    ...
    <div className="mx-auto max-w-3xl">
      <div className="mb-6">
        ...
        <p className="text-sm text-slate-500">
          Find an active contest and start competing.
        </p>
      </div>
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <Badge variant={contest.lifecycle_status === "LIVE" ? "default" : "secondary"}>
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {registration && contest.lifecycle_status === "REGISTRATION_OPEN" && (
                    <Button
                      variant="outline"
                      onClick={() =>
                        handleWithdraw(contest.id, registration.id)
                      }
                      disabled={actionId === contest.id}
                      className="gap-1.5"
                    >
